...
public class Assets {
	...
	public static BufferedImage wave_target, hover_target, hit_target, sink_target, filter, btn_start, btn_start_hover, game_title;
	...
	private static void loadTargets() {
		...
		wave_target = targetsSheet.crop(0, 0, 200, 200);
		hit_target = targetsSheet.crop(200, 0, 200, 200);
		hover_target = targetsSheet.crop(400, 0, 200, 200);
